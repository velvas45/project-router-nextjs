...
function FilteredEventsPage(props) {
  ...
  const {data,error} = useSWR('https://nextjs-course-academind-default-rtdb.firebaseio.com/events.json')
  ...
  if(isNaN(numYear) || isNaN(numMonth) || numYear > 2030 || numMonth < 1 || numMonth > 12 || error) {
    return (
      <Fragment>
      {pageHeadData}
      <ErrorAlert>
